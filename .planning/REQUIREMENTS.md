...
- [ ] **FOUND-01**: Project scaffolded with Vite + React 18 + TypeScript, all specified dependencies installed (react-leaflet, Tailwind CSS v3, Recharts, Zustand, lucide-react)
- [ ] **FOUND-02**: Tailwind configured with INRIX design tokens (exact hex colors for background, nav, accent, congestion, alerts)
...
- [ ] **FOUND-04**: Navigation between Mission Control and Signal Analytics views via nav bar module name area
